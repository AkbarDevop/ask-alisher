...
const RECENT_SUGGESTED_QUESTIONS = {
  en: [
    ...
    "What are your latest plans for connecting Uzbek youth with global business schools?",
  ...
  uz: [
    ...
    "O'zbek yoshlarini global biznes maktablari bilan bog'lash bo'yicha so'nggi rejalaringiz qanday?",
